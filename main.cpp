...
//    if (!texture_strawberry.loadFromFile("strawberry.png")) {
//        cerr << "Failed to load texture!" << endl;
//        return -1;
//    }
//    Sprite strawberry(texture_strawberry);
//  
//    // Создаем змейку
...
//            /*|| snake.size() > 0 && snake[0].getGlobalBounds().intersects(strawberry.getGlobalBounds())*/) {
//
//            for (int i = 0; i < 2; i++) {
...
//            //}
//            //else {
//            //    strawberry.setPosition(width_random, height_random);
//            //}
//            //isApple = !isApple;
//
//
